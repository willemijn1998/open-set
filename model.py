## COPIED FROM: https://github.com/yue-zhongqi/gcm-cf 
...
class LVAE(nn.Module):
    def __init__(self, in_ch=3,
        ...
        ## ugly add by WT
        # converts tensor from embeddings len 32 to class len 
        self.classifier = nn.Linear(32, self.num_class)
        # Converts a tensor of class-length to tensor of embedding length 32 
    ...
    def lnet(self, x, y_de, args):
        ...
        # split z and y
        z_latent_mu, y_latent_mu = mu_latent.split([args.len_Z, args.len_Y], dim=1)
        z_latent_var, y_latent_var = var_latent.split([args.len_Z, args.len_Y], dim=1)
    ...
    def loss(self, x, y, y_de, beta, lamda, args):
        ...
        # print for debugging: 
        # print("rec loss: ", rec, 'kl loss ', kl, 'ce loss ', lamda*ce, 'contrast loss ', contra_loss)
    ...
    def contrastive_loss(self, x, target, rec_x, args):
        ...
        target_en = torch.eye(args.num_classes) # 6x6 
        ...
        # y_neg are the embedding counterfacts y 
    ...
    def generate_cf(self, x, y_de, mean_y, args):
        ...
        """
        if mean_y.dim() == 2:
            # The amount of counterfact classes 
